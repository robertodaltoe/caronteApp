...
# Costanti e helper condivisi: spostati in recupero_costanti.py (passo 1
# dello split del file, per evitare import circolari con i sotto-moduli
# che verranno estratti in seguito). Re-importati qui con gli stessi nomi
# cosi' tutto il resto del file continua a funzionare senza modifiche.
...
# Importa le route di export, definite in un sotto-modulo separato per
# tenere questo file più piccolo. L'import va in fondo (dopo che
# recupero_bp esiste già in questo modulo) cosi' recupero_export.py può
# importare recupero_bp da qui senza creare un ciclo: quando Python
# esegue questa riga, il modulo routes.recupero è già parzialmente
# inizializzato con recupero_bp definito, quindi recupero_export lo trova.
